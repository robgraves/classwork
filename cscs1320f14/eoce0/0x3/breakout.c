...
//appaears to be changing red green blue and alpha layers
//based on whether its big endian or little endian
...
//defining a player struct and
//and a missile struct and an object struct
    struct player {
        SDL_Surface *sprite;
        SDL_Rect     pos;
    };
    ...
    //instantiating a Player named paddle
    //a Missile named ball and an Object
    //name brick with both rows and columns
    Player  paddle;
    Missile ball;
    ...
    while (quit == NO)
    {
        ...
        //attempt at TAB cheat
        //works only while TAB is pressed or
        //repeatedly pressed
        else if (keystate[SDLK_TAB]    == YES)
        {
            ball.pos.x=paddle.pos.x;
        }
        /*
        //added up movement of paddle
        else if (keystate[SDLK_UP]     == YES)
        {
            paddle.pos.y=paddle.pos.y-15;
        }
        //added downmovement of paddle
        else if (keystate[SDLK_DOWN]   == YES)
        {
            paddle.pos.y=paddle.pos.y+15;
        }
        */
